...
(0, _page.default)('*', function (ctx, next) {
  window.scrollTo(0, 0);
  next();
});
...
},{"./inicio":16,"page":11}],16:[function(require,module,exports){
"use strict";
...
(0, _page.default)('/', function (ctx, next) {
  ...
  (0, _emptyElement.default)(main).appendChild(_template.default);
});
...
module.exports = (0, _yoYo.default)(_templateObject());
